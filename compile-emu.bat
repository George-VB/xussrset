...
:: компилируем
scripts\change.pl xussr-emu.nml "\s*\{\s*" "\n\{\n"
scripts\change.pl xussr-emu.nml "\s*\}\s*" "\n\}\n"
scripts\change.pl xussr-emu.nml "\;" "\;\n"
scripts\change.pl xussr-emu.nml "\n\r*\n" "\n"
scripts\change.pl xussr-emu.nml "\{\s*([a-z0-9_ ]+);\s*\}" "{ $1; }"
...
echo TITLE    :xUSSR Railway EMUs Set 0.9-dev.r%REPO_REVISION%
