...
:: компилируем
scripts\change.pl xussr-subway.nml "\s*\{\s*" "\n\{\n"
scripts\change.pl xussr-subway.nml "\s*\}\s*" "\n\}\n"
scripts\change.pl xussr-subway.nml "\;" "\;\n"
scripts\change.pl xussr-subway.nml "\n\r*\n" "\n"
scripts\change.pl xussr-subway.nml "\{\s*([a-z0-9_ ]+);\s*\}" "{ $1; }"

del xussr-subway.bak
...
echo TITLE    :xUSSR Subways Set 0.8.2alpha0.r%REPO_REVISION%
