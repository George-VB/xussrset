...
:: компилируем
scripts\change.pl xussr-stationratings.nml "\s*\{\s*" "\n\{\n"
scripts\change.pl xussr-stationratings.nml "\s*\}\s*" "\n\}\n"
scripts\change.pl xussr-stationratings.nml "\;" "\;\n"
scripts\change.pl xussr-stationratings.nml "\n\r*\n" "\n"
scripts\change.pl xussr-stationratings.nml "\{\s*([a-z0-9_ ]+);\s*\}" "{ $1; }"

del xussr-stationratings.bak
...
echo TITLE    :Station ratings modifier 0.1.r%REPO_REVISION%
...
:SelfConfig
:: имя файла с набором
set NMLNAME=xussr-stationratings
