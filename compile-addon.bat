...
:: компилируем
scripts\change.pl xussr-addon.nml "\) \{" "\)\n\{"
scripts\change.pl xussr-addon.nml "\} switch" "\}\nswitch"
scripts\change.pl xussr-addon.nml "\; " "\;\n"
...
echo TITLE    :xUSSR Railway Set addon 0.2-dev.r%REPO_REVISION%
