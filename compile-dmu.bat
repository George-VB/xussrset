...
:: компилируем
scripts\change.pl xussr-dmu.nml "\s*\{\s*" "\n\{\n"
scripts\change.pl xussr-dmu.nml "\s*\}\s*" "\n\}\n"
scripts\change.pl xussr-dmu.nml "\;" "\;\n"
scripts\change.pl xussr-dmu.nml "\n\r*\n" "\n"
scripts\change.pl xussr-dmu.nml "\{\s*([a-z0-9_ ]+);\s*\}" "{ $1; }"
...
echo TITLE    :xUSSR Railway DMUs Set 0.8-dev.r%REPO_REVISION%
