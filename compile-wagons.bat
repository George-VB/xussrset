...
:: компилируем
scripts\change.pl xussr-wagons.nml "\s*\{\s*" "\n\{\n  "
scripts\change.pl xussr-wagons.nml "\s*\}\s*" "\n\}\n"
scripts\change.pl xussr-wagons.nml "\;" "\;\n"
scripts\change.pl xussr-wagons.nml "\n\r*\n" "\n"
scripts\change.pl xussr-wagons.nml "\{\s*([a-z0-9_ ]+);\s*\}" "{ $1; }"
scripts\CleanCargoesLists.pl xussr-wagons.nml

del xussr-wagons.bak
...
echo TITLE    :xUSSR Railway Wagons Set 0.8-dev.r%REPO_REVISION%
