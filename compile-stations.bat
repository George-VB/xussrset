...
:: компилируем
scripts\change.pl xussr-stations.nml "\) \{" "\)\n\{"
scripts\change.pl xussr-stations.nml "\} switch" "\}\nswitch"
scripts\change.pl xussr-stations.nml "\; " "\;\n"

del xussr-stations.bak
...
echo TITLE    :xUSSR Stations Set 0.1.r%REPO_REVISION%
